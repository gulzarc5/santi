<?php
  ...
  function showMessage($msg){
    if ($msg == 1) {
      print "<p class='alert alert-success'>Balance Deducted Successfully</p>";
    }
    if ($msg == 2) {
      print "<p class='alert alert-danger'>Something Went Wrong Please Try Again</p>";
    }
    if ($msg == 3) {
      print "<p class='alert alert-danger'>Please Enter Amount Less Then Or Equal to Wallet Balance</p>";
    }
  }
?>      
  ...
  <div class="clearfix"></div>
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2 style="color:red">Deduct Wallet Balance</h2>
            <div class="clearfix"></div>
            <?php
                if (isset($_GET['msg'])) {
          ...
          <div class="x_content"><br />
            <form  class="form-horizontal form-label-left" action="php/wallet/deduct_wallet_balance.php" method="post">
              <?php
                if (isset($_GET['u_id'])) {
                  $row_wallet = 0.00;
              ...
              <div class="ln_solid"></div>
                <div class="form-group">
                  <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    <button type="submit" name="submit" value="submit" class="btn btn-danger">Deduct From Wallet</button>
