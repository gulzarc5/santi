...
if(isset($_POST['category']) && !empty($_POST['sub_category'])){
    ...
    if (!empty($image['name'])) {
        ...
        if ($image_size > 2097152 || $image_size < 2 ) {
                header("location:../../add_category_form.php?msg=6");
                die();
        }
        ...
        if( $ext=='jpg' || $ext=='jpeg' || $ext=='png' || $ext=='bmp' || $ext=='gif' ){
            ...
            header("location:../../add_category_form.php?msg=4");
            die();
        }
    }


    $sql ="INSERT INTO `sub_category`(`id`, `name`, `category_id`,`image`) VALUES (null,'$sub_category','$category','$image_name')";
