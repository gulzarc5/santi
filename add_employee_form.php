<?php
  ...
  function showMessage($msg){
    ...
    if ($msg == 1) {
      print "<p class='alert alert-success'>Employee Created Successfully</p>";
    }
    if ($msg == 2) {
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content"><br />
            <form action="php/employee/add_employee.php" method="post" class="form-horizontal form-label-left">
