      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content"><br />
            ...
            ?>
            <form action="php/employee/update_employee.php" method="post" class="form-horizontal form-label-left">
          ...
          <!--     <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input  class="form-control col-md-7 col-xs-12" type="text" name="state" required value="<?php echo $user_row['state']; ?>">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input  class="form-control col-md-7 col-xs-12" type="test" name="city" required value="<?php echo $user_row['city']; ?>">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <textarea name="address" class="form-control col-md-7 col-xs-12"><?php echo $user_row['address']; ?></textarea>
                </div>
              </div>
<!-- 
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input  class="form-control col-md-7 col-xs-12" type="text" name="pin" value="<?php echo $user_row['pin']; ?>">
                </div>
              </div> -->
